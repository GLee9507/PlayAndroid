...
public class ArticleBean {
    ...
    public static class DatasBean {
         ...
         * fresh : false
         * id : 2916
         * link : https://www.jianshu.com/p/09f2689499d0
         * niceDate : 2018-05-14
         * origin :
         * projectLink :
         * publishTime : 1526298411000
         * superChapterId : 135
         * superChapterName : 项目必备
         * tags : []
         * title : 优雅地实现Android主流图片加载框架封装，可无侵入切换框架
         * type : 0
         * userId : -1
         * visible : 1
         * zan : 0
